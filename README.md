...
**Лінійний пошук** - послідовний АП, починається з одного кінця і проходить кожен елемент до знаходження цілі. Можна використовувати до невідстортованого масиву, для масивів будь-якого типу; не потребує додаткової пам'яті, підходить для невеликих наборів. Часова складність O(N), повільний для великих наборів.  
...
**Двійковий пошук** - інтервальний АП, використовується у відсортованих структурах шляхом ділення інтервалу пошуку навпіл. Часова складність O(log N).
