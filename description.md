...
Лінійна СД, зберігає дані в нерозривній частині пам'яті. Базується на прив'язці даних до індексів.  
...
Лінійна СД, елементи зберігаютсья в різних частинах пам'яті. Елементи зв'язані за допомогою посилань.  
